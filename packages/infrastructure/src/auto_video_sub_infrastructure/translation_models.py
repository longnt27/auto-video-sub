...
class ContextVersionModel(Base):
    ...
    parent_version_id: Mapped[UUID | None] = mapped_column(
        Uuid, ForeignKey("context_versions.id", ondelete="SET NULL"), nullable=True
    )
...
class ContextEntityModel(Base):
    ...
    id: Mapped[UUID] = mapped_column(Uuid, primary_key=True)
    context_version_id: Mapped[UUID] = mapped_column(
        Uuid, ForeignKey("context_versions.id", ondelete="CASCADE"), nullable=False
    )
...
class TranslationStateModel(Base):
    ...
    policy_version_id: Mapped[UUID] = mapped_column(
        Uuid, ForeignKey("translation_policy_versions.id", ondelete="RESTRICT"), nullable=False
    )
    context_version_id: Mapped[UUID | None] = mapped_column(
        Uuid, ForeignKey("context_versions.id", ondelete="RESTRICT"), nullable=True
    )
...
class TranslationBatchModel(Base):
    ...
    context_version_id: Mapped[UUID] = mapped_column(
        Uuid, ForeignKey("context_versions.id", ondelete="RESTRICT"), nullable=False
    )
    policy_version_id: Mapped[UUID] = mapped_column(
        Uuid, ForeignKey("translation_policy_versions.id", ondelete="RESTRICT"), nullable=False
    )
...
class TranslationRevisionModel(Base):
    ...
    parent_revision_id: Mapped[UUID | None] = mapped_column(
        Uuid, ForeignKey("translation_revisions.id", ondelete="SET NULL"), nullable=True
    )
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True))
